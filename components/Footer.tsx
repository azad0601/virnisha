        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-1">
            <Link
              ...
              aria-label="VIRNISHA OVERSEAS — Home"
            >
              ...
              <div className="leading-tight">
                ...
                <span className="block font-semibold text-gold text-xs tracking-widest">
                  OVERSEAS
                </span>
              </div>
            </Link>
            ...
            <p className="text-blue-300 text-xs leading-relaxed">
              A sourcing portfolio for pharmaceutical, chemical and industrial
              requirements.
            </p>
          </div>
            ...
            <address className="not-italic space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <a
                  ...
                  className="text-blue-200 text-sm hover:text-white transition-colors break-all"
                >
